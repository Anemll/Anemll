...
"""
Test script for LLaMA model conversion and inference with 4K context.
"""
...
def run_llama_tests():
    """Run LLaMA model tests with 4K context size"""
...
"""
    ...
    print("=== LLaMA Model Test Suite (4K Context) ===")
    
    # Test different LLaMA models with 4K context
    test_cases = [
        {
            "name": "LLaMA 3.2 1B Instruct (4K context)",
            "model": "meta-llama/Llama-3.2-1B-Instruct",
            "output": "/tmp/test-llama-1b-instruct-4k",
            "chunks": "2"
        }
    ]
